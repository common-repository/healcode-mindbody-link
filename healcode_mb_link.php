<?php
/*
Plugin Name: MINDBODY Login
Plugin URI: https://wordpress.org/plugins/healcode-mindbody-link/
Description: Add a MINDBODY Link to your WordPress main navigation menu.
Version: 1.2.5
Author: MINDBODY
...
// ***********************************************************
// Adding the Top Level menu for MINDBODY Links
// ***********************************************************

function add_html_menu_item() {
    add_menu_page(
        'MINDBODY Login Settings',
        'MB Login Link',
        'manage_options',
        'html-menu-healcode',
        'menu_html_options',
        plugins_url('healcode-mindbody-link/images/mblogo.png')
    );
}
...
// *********************************************
    ...
    <!-- Header Links to our About page in WordPress and MINDBODY -->
...
<table style="float:right; ">
    <tr>
        ...
        <td style="float:right;">
            <a class="hc_header_link" target="_blank" href="https://www.mindbodyonline.com/">MINDBODY</a>
        </td>
...
<?php echo "<h2>" . __( 'MINDBODY Login Settings', 'menu-test' ) . "</h2>"; ?>
<div class="hc-link-code-example">
    Paste your MINDBODY Link code in the form below. Once you click the 'Save Changes' button, the MINDBODY Link will appear in your site's menu.</br>
    To get your code, go to the Links page in your MINDBODY Branded Web Manager:
...
<!-- ----------------- Form for inputting MINDBODY Link code ----------------- -->
...
<div style="width: 100%">
    <div class="hc_feedback_links">
        ...
        <a target="_blank" href="https://support.mindbodyonline.com/s/article/ka032000000LBZOAA4/Adding-Login-Register-links-using-our-plugin-WordPress-only-branded-web-tools-formerly-HealCode?language=en_US">Instructions</a>
        <a target="_blank" href="https://support.mindbodyonline.com" class="">Tech Support</a>
        <a target="_blank" href="https://manager.healcode.com/users/sign_in" class="">Login to MINDBODY Branded Web Manager</a>
    </div>
    <p></p>
</div>
